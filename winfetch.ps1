...
$img = if (-not $noimage) {
    if ($image) {
        ...
        if ($logo -eq "Windows 11") {
            ...
            Write-Error 'logo avialable are Windows 11, Windows 10/8.1/8, Windows 7/Vista/XP, Hello and Girl.'
            exit 1
        }
    }
}
...
function info_colorbar {
    return @(
        @{
            title   = "${e}[1;33m/-------${e}[1;34m-------${e}[1;35m-------${e}[1;36m-------${e}[1;31m-------${e}[1;32m-------/${e}"
            content = ""
        },
        @{
...
function info_dashes {
    ...
    return @{
        title   = ""
        content = "${e}[1;33m|----${e}[1;35m-----${e}[1;36m------${e}[;33m Computer info ${e}[1;36m------${e}[1;31m-----${e}[1;32m----|"
    }
}
