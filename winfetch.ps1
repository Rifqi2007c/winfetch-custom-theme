...
$img = if (-not $noimage) {
    if ($image) {
        ...
        if ($logo -eq "Windows 11") {
            ...
            Write-Error 'logo avialable are Windows 11, Windows 10/8.1/8, Windows 7/Vista/XP, Microsoft, Windows 2000/98/95, Hello, Girl, Flamingo. Girl2,'
            exit 1
        }
    }
}
...
function info_colorbar {
    return @(
        @{
            title   = "${e}[1;33m/--󰮯${e}[1;30m󰇘${e}[1;31m󰊠${e}[1;36m󰊠${e}[1;35m󰊠${e}[1;33m󰊠${e}[1;34m----${e}[1;35m-------${e}[1;36m-------${e}[1;31m---${e}[1;32m-------/${e}"
            content = ""
        },
        @{
            title   = "         ${e}[1;30m>----- ${e}[1;31mHEL${e}[1;33mLO ${e}[1;34mW${e}[1;36mO${e}[1;32mRL${e}[1;35mD_ ${e}[1;30m-----<"
            content = ""
        }
    )
}
...
function info_motherboard {
    ...
    return @{
        title = " ${e}[1;36m > ${e}[1;33mMotherboard"
...
function info_resolution {
    ...
    return @{
        title   = " ${e}[1;36m󰹑 > ${e}[1;33mResolution"
...
function info_cpu_usage {
    ...
    return @{
        title   = " ${e}[1;36m > ${e}[1;33mCPU Usage"
        ...
        if ($showDisks.Contains($diskLetter) -or $showDisks.Contains("*")) {
            try {
                if ($_.TotalSize -gt 0) {
                    ...
                    [void]$lines.Add(@{
                        title   = " ${e}[1;36m > ${e}[1;33mDisk ($diskLetter)"
